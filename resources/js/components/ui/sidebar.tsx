    ...
    return (
        ...
        >
            ...
            >
                <div
                    data-sidebar="sidebar"
                    className="flex h-full w-full flex-col overflow-y-auto bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm"
                >
                    {children}
                </div>
            </div>
